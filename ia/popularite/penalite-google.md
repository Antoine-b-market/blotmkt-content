...
> - Une pénalité Google est une sanction directe ou algorithmique qui provoque une chute brutale de trafic organique et se distingue par sa présence ou non dans la section "[action](https://blotmkt.com/ia/Audit/first-input-delay)s manuelles" de la Google Search Console
...
Identifiez tous les liens problématiques, supprimez-les ou utilisez l'outil de désaveu, documentez chaque action dans un [Fichier](https://blotmkt.com/ia/Audit/budget-de-crawl) partagé, puis soumettez une demande de réexamen détaillée expliquant les corrections apportées et les mesures préventives mises en place.
