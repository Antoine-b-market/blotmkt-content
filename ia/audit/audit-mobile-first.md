...
> - La méthode complète comprend 4 étapes : crawl technique avec user-agent mobile, analyse des [Core Web Vitals](https://blotmkt.com/ia/audit/core-web-vitals), Audit de contenu/UX et tests en conditions réelles
