...
Vous faites partie des 41% de sites mobiles qui échouent aux [Core Web Vitals](https://blotmkt.com/ia/audit/core-web-vitals.html) en 2024
...
Le LCP est une métrique stable des Core Web Vitals qui mesure la [Vitesse de chargement](https://blotmkt.com/ia/audit/vitesse-de-chargement.html) perçue, marquant le moment où le contenu principal de la page s'est probablement chargé
...
Les [Taux de rebond](https://blotmkt.com/ia/audit/taux-de-rebond.html) doublent plus que proportionnellement en comparant les cohortes LCP de 2 secondes vs 5 secondes
. 
